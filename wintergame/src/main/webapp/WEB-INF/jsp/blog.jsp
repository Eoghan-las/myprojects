			...
			<div id="posts-list">
				...
				<c:forEach items="${games }" var="games">
					...
					<div class="entry-date">
						...
						<div id="year" class="year">${games.messagetime}</div>
					</div>
					<h2 class="post-heading">
						<a href="single.action?gid=${games.zid }">${games.ztitle }</a>
					</h2>
					<div class="excerpt">${games.zcontent }</div>
					<a href="index.action" class="read-more">continue &#8594;</a>
					<div class="meta">
